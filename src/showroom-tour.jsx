    ...
    <main className="tour-page">
      ...
      <section className="tour-hero container">
        <div className="tour-copy">
          ...
          <h1>Walk through your next <em>beautiful home.</em></h1>
          <p>A professional showroom host takes you through our curated beds, sofas and home electronics—so you can compare comfort, craft and everyday function before you visit.</p>
          <div className="tour-proof"><ShieldCheck size={18} /> Live product guidance &amp; WhatsApp quote support</div>
        ...
        <div className="tour-video-shell">
          ...
          <iframe
            ...
            title="Furniture and electronics showroom tour"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
          />
          <span className="tour-video-label">Showroom walkthrough · Beds · Sofas · Electronics</span>
        </div>
      </section>

      <section className="tour-highlights container">
        <header>
          <span className="tour-kicker">What the tour covers</span>
          <h2>Everything you need for a complete room.</h2>
        </header>
        <div className="tour-highlight-grid">
          <article><BedDouble size={25} /><h3>Solid-wood beds</h3><p>Storage, finishes, dimensions and craftsmanship explained in person.</p></article>
          ...
          <article><Tv size={25} /><h3>Smart electronics</h3><p>See television, sound and appliance options for your home setup.</p></article>
        </div>
      </section>
    </main>
  );
